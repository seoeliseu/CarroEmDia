        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "TEXT", unicode: false, maxLength: 500, nullable: false),
                    IntervalInMonths = table.Column<int>(type: "INTEGER", nullable: true),
                    IntervalInKilometers = table.Column<int>(type: "INTEGER", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaintenanceTypeId = table.Column<int>(type: "INTEGER", unicode: false, nullable: false),
                    ...
                    NextExpectedMaintenanceMileage = table.Column<int>(type: "INTEGER", nullable: true),
                    NextExpectedMaintenanceDate = table.Column<DateTime>(type: "TEXT", nullable: true),
                    IsCompleted = table.Column<bool>(type: "INTEGER", nullable: false),
                    RememberAt = table.Column<DateTime>(type: "TEXT", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
